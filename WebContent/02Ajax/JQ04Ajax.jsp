...
$(function(){
	...
	*/
	$.ajax({
		url : './common/04JsData.js', //요청 url
		type : 'get', //요청시 사용할 전송 방식
		//contentType : 요청시 사용할 컨텐츠 타입
		dataType : "script",//콜백 데이터형식
		//data : 파라미터
		//요청성공시 콜백 메소드 : 무기명함수 형태로 정의됨
		success : function(resData){//요청에 성공했을때 콜백 메소드
			MyAlert("Hello", " AJAX");
		},
